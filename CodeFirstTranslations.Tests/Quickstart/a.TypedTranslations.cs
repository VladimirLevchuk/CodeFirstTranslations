...
namespace CodeFirstTranslations.Tests.Quickstart
{
    public class TypedTranslations : TestBase
    {
        public class Translations
        {
            ...
            /// </summary>
            public static Translation Bye = new TranslationField("Bye!");
            /// <summary>
            ...
            /// </summary>
            public static Translation NameInUse = new TranslationField("The name you entered is already in use, please choose a different name",
                alternativeKeys: new[]
                {
